...
public class UserProjectsRepository {
    ...
    public UserProjectsRepository(NamedParameterJdbcTemplate jdbcTemplate) {

        this.jdbcTemplate = jdbcTemplate;
    }

    public Optional<UserProject> findUserProjectsByPersonUsernameAndProjectId(String username, Integer projectId) {
