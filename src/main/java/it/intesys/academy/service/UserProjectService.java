...
public class UserProjectService {
    ...
    public UserProjectService(UserProjectRepository userProjectRepository,ProjectRepository projectRepository, PersonRepository personRepository) {
    ...
    public boolean canThisUserReadThisProject(String username, int projectId) {
        ...
        return ! userProjectRepository.findUserProjectByPersonUsernameAndProjectId(username, projectId).isEmpty();
    ...
    public List<Integer> getUserProjects(String username) {
       ...
       return projects.stream().map(UserProject::getProject).map(Project::getId).toList();
